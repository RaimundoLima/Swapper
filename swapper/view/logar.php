...
?>
    ...
    <div class="row" id="conteudo">
        <div class="col s10">
            ...
            <form method="POST" action="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/logando'; ?>">
                <div class="row">
                ...
                <div class="row col s12">
                    <a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/view/esqueceusenha.php'; ?>" id="esqueceu-senha">
                        Esqueceu sua senha?
                    </a>
                </div>
        ...
        <div class="col s10">
            ...
            <div>
                <?php
                    include_once($base_dir.'/model/loginalternativo/google/google.php');
